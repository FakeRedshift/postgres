...
PG_KEYWORD("auto", AUTO, UNRESERVED_KEYWORD)
PG_KEYWORD("backup", BACKUP, UNRESERVED_KEYWORD)
...
PG_KEYWORD("even", EVEN, UNRESERVED_KEYWORD)
...
PG_KEYWORD("sortkey", SORTKEY, UNRESERVED_KEYWORD)
